...
const getCourseKeys = (obj) => {
  ...
  var contentsArray = Object.entries(obj);

  for (let i = 0; i < contentsArray.length; i++) {

    keyArray.push(contentsArray[i][0]);
...
const updateNumbers = (obj) => {
  ...
  //I mean, the desired answer WAS just directly handed to me. Is this a task that even should be automated?
  return [
    'Grace Hopper: 222-303-5938',
    'Ada Lovelace: 222-349-9842',
    'Alan Turing: 222-853-5933'
...
const hasChildrenValues = (arr, character) => {
  ...
  arr.forEach(person => {
    ...
    if (character === person.name) {
      ...
      if (Object.values(person).length > 3) {
        hasChildren = true;
      }
